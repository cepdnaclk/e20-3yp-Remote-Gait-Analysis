...
const FootOrientationGraphV2 = ({ sensorData }) => {
  ...
  useEffect(() => {
    if (sensorData) {
      // Convert sensorData to imuData format
      const imuData = {
        timestamp: sensorData.timestamp / 1000, // Convert to seconds if needed
        orientation: {
          yaw: sensorData.yaw,
...
export default React.memo(FootOrientationGraphV2);
